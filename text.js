let AllText =[
    {
        ...
        Columns:[
            {
                Tag: "Địa Chỉ",
                Text: `Bình Liêu là một huyện miền núi phía Đông Bắc của tỉnh Quảng Ninh. 
            ...
            {
                Tag: "Đặc Điểm",
                Text: `Bình Liêu xứng đáng là top đầu trong du lịch núi ở Quảng Ninh với tên gọi “Sa Pa” 
                thu nhỏ của Quảng Ninh. Sở hữu 4 mùa trong một ngày. Vì thế, bạn có thể du lịch đến Bình Liêu 
                bất cứ thời điểm nào cũng được.`,
            },
            {
                Tag: "Lễ Hội",
                Text: `- Mùa xuân có các lễ hội như lễ hội Đình Lục Nà (từ 16-18 tháng Giêng Âm lịch, Hội hát
                    Soóng Cọ giao duyên ngày 16/3 âm lịch, ngày “Kiêng gió” ngày 4/4 âm lịch, các ngày hội đều đậm chất 
                    “chợ tình” vùng cao).
                    - Lễ hội mùa hoa Trẩu cuối tháng 3, đầu tháng 4. 
                    - Lễ hội hoa sở Bình Liêu diễn ra vào cuối tháng 11 và trung tuần tháng 12. `,
            },
            {
                Tag: "Lưu Ý",
                Text: `Nếu bạn đi vào mùa đông nên chú ý đến việc giữ ấm, vì trên đỉnh núi nhiệt độ có thể xuống rất thấp.
    ...
    },
    {
        ...
        Columns:[
            {
                Tag: "Địa Chỉ",
                Text: `Chùa Yên Tử Quảng Ninh là một ngôi chùa nổi tiếng được yêu thích bậc nhất ở Việt Nam. Ngôi chùa
            ...
            {
                Tag: "Đặc Điểm",
                Text: `Là địa điểm du lịch Quảng Ninh linh thiêng, chùa Yên Tử không chỉ gây ấn tượng bởi độ cao 1068m mà còn 
                ...
                gỗ lim chắc chắn, dưới chân có phiến đá lớn bao quanh.
            ...
            {
                Tag: "Lễ Hội",
                Text: `Bạn có thể đi chùa Yên Tử Quảng Ninh bất cứ thời điểm nào trong năm nhưng thời điểm thích hợp với nhiều hoạt động 
                ...
                thu hút đông đảo du khách xa gần.
            ...
            {
                Tag: "Lưu Ý",
                Text: `Nếu bạn đi thăm chùa Đồng(ngôi chùa cao nhất trong quần thể chùa Yên Từ) bạn hãy chú ý đến sức khỏe bởi đường
                đi lên khá dốc và lạnh.
                Nhưng bạn cũng có thể thăm chùa Đồng bằng cáp treo nhé.`,
            },
        ]
    },
    {
        ...
        Columns:[
            {
                Tag: "Địa Chỉ",
                Text: `Vịnh Hạ Long nằm thuộc bộ phận của vịnh Bắc Bộ, phía Đông Bắc giáp với vịnh Bái Tử Long, phía Tây Nam giáp 
            ...
            {
                Tag: "Đặc Điểm",
                Text: `Vịnh Hạ Long là quần thể danh lam thắng cảnh nổi tiếng gồm 2000 hòn đảo lớn nhỏ tại Hạ Long. Chiêm ngưỡng từ 
            ...
            {
                Tag: "Lễ Hội",
                Text: `Nếu như bạn đã khám phá Hạ long ở phía biển. Bạn có thể ghé qua Phố cổ Hạ Long, nơi đây được mô phỏng theo kiến trúc của phố cổ Hà Nội
